...
princp=[]
try:
	prox= requests.get('https://github.com/farhanmallik51/Bal/blob/main/Bal.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/farhanmallik51/Bal/blob/main/Bal.txt').text
		ua=open('.bbnew.txt','w')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/farhanmallik51/Bal/blob/main/Bal.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
